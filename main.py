...
async def on_message(message):
    ...
    if message.content.startswith('ぼれろ、しょうかい'):
        ...
        roushi = ['★☆☆懇浪','★☆☆コンコン','★☆☆浪士','★☆☆ン浪','★☆☆ろーし','★☆☆:gotume~kawauso:','★☆☆ヤクザ','★☆☆つままれたきつね','★☆☆スジモンきつね','★☆☆おあげ','★☆☆キツネ','★★☆コンコン浪士','★★☆懇々浪士','★★☆組長','★★☆コンコン浪士"メイド服"','★★☆コンコン浪士"チーパオ"','★★☆コンコン浪士"ディアンドル"','★★☆伝説の名前','★★☆著名な祖父を持ちし孫','★★★★★ろうてゃ','★★★コンコン老人','★★★★士浪ンコンコ',]
